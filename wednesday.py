...
def main():
    ...
    url = 'https://api.planningcenteronline.com/publishing/v2/channels/12961/episodes'
    today = date.today() + timedelta(days=6)
    serviceDate = today.strftime('%B %d, %Y\"')
    serviceDate = '\"Wednesday, ' + serviceDate
    ...
    youtubeEmbed = '{\"data\":{\"attributes\":{\"starts_at\":'+startsAt+',\"video_embed_code\":\"<iframe width=\"560\" height=\"315\" src=\"https:\/\/www.youtube.com\/embed\/RaDDkBdBMRA\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen><\/iframe>\"}}}'
    print(youtubeEmbed)
